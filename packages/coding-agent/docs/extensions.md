...
| Package | Purpose |
|---------|---------|
| `@noorm/lumpi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
...
```typescript
import { isToolCallEventType } from "@noorm/lumpi-coding-agent";
...
```typescript
import { isBashToolResult } from "@noorm/lumpi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@noorm/lumpi-coding-agent";
...
```typescript
import { CONFIG_DIR_NAME, type ExtensionAPI } from "@noorm/lumpi-coding-agent";
...
```typescript
import { SessionManager } from "@noorm/lumpi-coding-agent";
...
```typescript
import { withFileMutationQueue } from "@noorm/lumpi-coding-agent";
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@noorm/lumpi-coding-agent";
...
```typescript
import { keyHint } from "@noorm/lumpi-coding-agent";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@noorm/lumpi-coding-agent";
