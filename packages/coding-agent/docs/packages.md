...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@noorm/lumi-ai`, `@noorm/lumi-agent-core`, `@noorm/lumi`, `@noorm/lumi-tui`, `typebox`.
