...
import type { AssistantMessage, Model } from "@noorm/lumi-ai";
...
vi.mock("@noorm/lumi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@noorm/lumi-ai/compat")>();
	return {
		...actual,
