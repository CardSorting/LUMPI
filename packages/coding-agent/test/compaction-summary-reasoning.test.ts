...
import type { AssistantMessage, Model } from "@noorm/lumpi-ai";
...
vi.mock("@noorm/lumpi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@noorm/lumpi-ai/compat")>();
	return {
		...actual,
