...
import { type ImageContent, modelsAreEqual } from "@noorm/lumi-ai";
import { initializeCliHostProvider } from "@noorm/lumi-codemarie";
...
import { CodemarieBridge } from "./core/codemarie-bridge.ts";
...
export async function main(args: string[], options?: MainOptions) {
	resetTimings();
	initializeCliHostProvider({ cwd: process.cwd() });
	...
	const codemarieBridge = new CodemarieBridge({
		cwd: sessionCwd,
