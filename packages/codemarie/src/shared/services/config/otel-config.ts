...
function getRuntimeOtelConfig(): OpenTelemetryClientConfig {
	return {
		...
		otlpMetricsProtocol:
			process.env.DIETCODE_OTEL_EXPORTER_OTLP_METRICS_PROTOCOL ||
			process.env.CLINE_OTEL_EXPORTER_OTLP_METRICS_PROTOCOL,
		otlpMetricsEndpoint:
			process.env.DIETCODE_OTEL_EXPORTER_OTLP_METRICS_ENDPOINT ||
		...
		metricExportInterval:
			process.env.DIETCODE_OTEL_METRIC_EXPORT_INTERVAL || process.env.CLINE_OTEL_METRIC_EXPORT_INTERVAL
				? Number.parseInt(
						process.env.DIETCODE_OTEL_METRIC_EXPORT_INTERVAL ||
							process.env.CLINE_OTEL_METRIC_EXPORT_INTERVAL ||
							"",
						10,
					)
				: undefined,
