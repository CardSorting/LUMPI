...
export const cloudflareModels = {
	...
	"@cf/meta/llama-3.3-70b-instruct-fp8-v2": {
		...
		outputPrice: 0.8,
		description:
			"Llama 3.3 70B is a powerful, high-performance model for complex reasoning and general-purpose tasks.",
	},
	...
	"@cf/zai-org/glm-5.2": {
		...
		cacheReadsPrice: 0.3,
		description:
			"GLM-5.2 is a frontier-scale reasoning model optimized for coding, tool use, and structured outputs.",
	},
...
export const nousResearchModels = {
	...
	"~anthropic/claude-opus-latest": {
		...
		cacheReadsPrice: 0.5,
		description:
			"Always routes to the latest model in the Claude Opus family. Currently resolves to Claude Opus 4.8.",
	},
