...
import { type FunctionDeclaration as GoogleTool, Type as GoogleToolParamType, type Schema } from "@google/genai";
import type { ChatCompletionTool as OpenAITool } from "openai/resources/chat/completions";
import type {
	FunctionTool as OpenAIResponseFunctionTool,
...
function replacer(description: string, context: SystemPromptContext): string {
	...
	return description
		.replace("{{BROWSER_VIEWPORT_WIDTH}}", String(width))
		.replace("{{BROWSER_VIEWPORT_HEIGHT}}", String(height));
}
