...
export type { JoyRideCacheDecision, JoyRideCommandLookupDecision, JoyRideDecisionContext, JoyRideDecisionType, JoyRideDegradedDecision, JoyRideDiagnosticOnlyDecision, JoyRideDisabledDecision, JoyRideFallbackBehavior, JoyRideHitDecision, JoyRideMissDecision, JoyRideRejectedDecision, JoyRideSearchLookupDecision, JoyRideStaleDecision, } from "./JoyRideDecisions.js";
...
export type { JoyRideCommandCacheEntry, JoyRideGrepCacheEntry, JoyRideSearchLookupOptions, } from "./JoyRideHotPathTypes.js";
...
export declare function getJoyRideCache(): JoyRideCache;
/** Extension deactivate shutdown — delegates to lifecycle helper. */
export declare function shutdownJoyRideCache(): number;
