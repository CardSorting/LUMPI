...
export function combineRuleToggles(
	toggles1: DietCodeRulesToggles,
	toggles2: DietCodeRulesToggles,
): DietCodeRulesToggles {
 ...
 */
export const getRuleFilesTotalContent = async (
 ...
 */
export async function ensureLocalDietCodeDirExists(
	dietcoderulePath: string,
