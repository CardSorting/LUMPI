...
export class HostProvider {
    ...
    constructor(createWebviewProvider, createDiffViewProvider, createCommentReviewController, createTerminalManager, hostBridge, logToChannel, getCallbackUrl, getBinaryLocation, extensionFsPath, globalStorageFsPath) {
    ...
    static initialize(webviewProviderCreator, diffViewProviderCreator, commentReviewControllerCreator, terminalManagerCreator, hostBridgeProvider, logToChannel, getCallbackUrl, getBinaryLocation, extensionFsPath, globalStorageFsPath) {
        if (HostProvider.instance) {
            throw new Error("Host provider has already been initialized.");
        }
        HostProvider.instance = new HostProvider(webviewProviderCreator, diffViewProviderCreator, commentReviewControllerCreator, terminalManagerCreator, hostBridgeProvider, logToChannel, getCallbackUrl, getBinaryLocation, extensionFsPath, globalStorageFsPath);
