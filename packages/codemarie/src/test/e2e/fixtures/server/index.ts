...
const useVerboseLogging =
	process.env.DIETCODE_E2E_TESTS_VERBOSE === "true" || process.env.CLINE_E2E_TESTS_VERBOSE === "true";
				...
				if (baseRoute === "/api/v1") {
					...
					if (endpoint === "/users/active-account" && method === "PUT") {
						...
						if (organizationId === null) {
							...
							const orgIndex = currentUser.organizations.findIndex(
