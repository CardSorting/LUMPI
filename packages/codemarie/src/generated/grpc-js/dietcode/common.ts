...
export const Diagnostic: MessageFns<Diagnostic> = {
	...
	fromPartial<I extends Exact<DeepPartial<Diagnostic>, I>>(object: I): Diagnostic {
		...
		message.range =
			object.range !== undefined && object.range !== null ? DiagnosticRange.fromPartial(object.range) : undefined;
...
export const DiagnosticRange: MessageFns<DiagnosticRange> = {
	...
	fromPartial<I extends Exact<DeepPartial<DiagnosticRange>, I>>(object: I): DiagnosticRange {
		const message = createBaseDiagnosticRange();
		message.start =
			object.start !== undefined && object.start !== null ? DiagnosticPosition.fromPartial(object.start) : undefined;
		message.end =
			object.end !== undefined && object.end !== null ? DiagnosticPosition.fromPartial(object.end) : undefined;
		return message;
	},
};
