...
- New tasks begin in PLAN MODE so you can explore and plan before making changes. The system automatically transitions to ACT MODE after you call plan_mode_respond with a finalized plan.
...
- When the plan is ready, present it via plan_mode_respond — implementation continues automatically in ACT MODE.
