...
description: "Templates for different types of LUMI documentation"
---
...
Use this template when explaining a LUMI feature. Focus on what it does, how to use it, and real examples.
...
### Example: LUMI Tools Guide

The [LUMI Tools Guide](/tools-reference/all-dietcode-tools) follows this pattern:
...
<Tip>
  ...
  LUMI helps you fill in each section based on your project.
</Tip>
