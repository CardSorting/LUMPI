...
1. Click **Settings** (top right of LUMI chat)
...
-   **Switch to bash** (solves most instances)
    ...
    1. Within LUMI, left-click the **Settings** button in the top right-hand corner of the chat window
...
-   Select **"WSL Bash"** in LUMI settings, under **"Terminal Settings"**
