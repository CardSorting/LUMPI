...
For detailed information on configuring STDIO and SSE transports in LUMI, including examples, see [Adding and Configuring MCP Servers](/mcp/adding-and-configuring-servers).
