...
Once authenticated, your credentials are securely stored and the server will reconnect automatically when you reload LUMI. You won't need to authenticate again unless you delete the server or your credentials expire.
...
Your Vercel authentication persists across sessions, so you won't need to re-authenticate each time you use LUMI.
