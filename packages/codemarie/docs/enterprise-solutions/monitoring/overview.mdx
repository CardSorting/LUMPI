...
description: "Optional telemetry and observability for your LUMI deployment"
---

LUMI includes optional monitoring capabilities for organizations that want to track usage and integrate with their observability infrastructure.
...
<CardGroup cols={1}>
  <Card title="LUMI Telemetry" icon="chart-simple" href="/enterprise-solutions/monitoring/telemetry">
    Built-in anonymous usage tracking that helps improve LUMI (opt-in)
  </Card>  
</CardGroup>

## LUMI Telemetry

LUMI includes opt-in telemetry for anonymous usage tracking:
...
Users can enable or disable telemetry in LUMI settings. All data is anonymous and does not include code content, file paths, or sensitive information.

See [LUMI Telemetry](/enterprise-solutions/monitoring/telemetry) for configuration details.

## OpenTelemetry Integration

For advanced monitoring needs, LUMI supports OpenTelemetry's OTLP (OpenTelemetry Protocol) for exporting metrics and logs to your own infrastructure.
...
### When to Use LUMI Telemetry
- You want to help improve LUMI through anonymous usage data
...
For basic telemetry, enable it in LUMI settings. For OpenTelemetry, see the configuration guide.
</Step>
...
All LUMI monitoring features are designed with privacy in mind:
