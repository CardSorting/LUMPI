...
<Tip>
API keys are stored locally in VS Code and are only used by the LUMI extension.
</Tip>
</Accordion>
...
Send a test message in LUMI to verify your connection works correctly with the LiteLLM proxy.
...
Confirm you're signed into the correct LUMI organization. Verify your administrator has saved the LiteLLM configuration and that you have the latest version of the LUMI extension.
...
- Regularly update the LUMI extension for security patches
