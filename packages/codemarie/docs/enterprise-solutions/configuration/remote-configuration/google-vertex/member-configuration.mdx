...
**LUMI extension installed and configured**  
The LUMI extension must be installed in VS Code and you need to be signed into your organization account. If you haven't installed LUMI yet, follow our [installation guide](/getting-started/installing-dietcode).

<Info>
**Quick Check**: Open the LUMI panel in VS Code. If you see your organization name in the bottom left, you're signed in correctly.
</Info>
...
Open VS Code and access the LUMI settings panel using either of these methods:

- Click the settings icon (⚙️) in the LUMI panel
...
4. LUMI will use your default Google Cloud credentials automatically
</Accordion>
...
4. LUMI will automatically detect credentials from your environment
</Accordion>
</AccordionGroup>
...
Send a test message in LUMI to verify your credentials work correctly with the configured Vertex AI project and region.
...
- **Image Analysis**: Upload images directly in LUMI for analysis
...
Confirm you're signed into the correct LUMI organization. Verify your administrator has saved the Vertex AI configuration and that you have the latest version of the LUMI extension.
