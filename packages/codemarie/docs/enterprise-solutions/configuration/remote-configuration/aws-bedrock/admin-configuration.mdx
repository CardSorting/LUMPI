...
Your AWS account needs specific Bedrock permissions to work with LUMI. 
...
Once saved, all organization members signed into the LUMI extension will automatically use AWS Bedrock with your configured settings. They won't be able to select other providers or switch to their personal LUMI accounts.
