...
description: "Configure Single Sign-On (SSO) for LUMI Enterprise via WorkOS AuthKit."
---

## Overview
LUMI Enterprise integrates with your identity provider (IdP) via **WorkOS AuthKit** for SSO.

This page describes, at a high level, how SSO is set up for LUMI Enterprise using WorkOS AuthKit.
...
To connect your IdP to LUMI Enterprise, configure your identity provider in **WorkOS AuthKit**:
...
LUMI Enterprise’s default SSO integration is **via WorkOS**.
...
## Troubleshooting
- **Redirect URI mismatch**: confirm the redirect/callback URL configured in WorkOS matches what was provided during your LUMI Enterprise onboarding.
