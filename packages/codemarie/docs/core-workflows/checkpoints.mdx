...
- [Auto Approve](/features/auto-approve) — pair with checkpoints for faster iteration
- [Security best practices](/SECURITY_BEST_PRACTICES) — approval gates when checkpoints are off
- [PROJECT_MAP](/PROJECT_MAP) — `src/integrations/checkpoints/` layout
